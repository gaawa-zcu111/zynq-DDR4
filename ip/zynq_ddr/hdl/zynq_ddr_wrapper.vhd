...
--Date        : Wed May 22 16:11:07 2024
--Host        : LAPTOP-N26RM7D0 running 64-bit major release  (build 9200)
--Command     : generate_target zynq_ddr_wrapper.bd
--Design      : zynq_ddr_wrapper
...
entity zynq_ddr_wrapper is
  port (
    calib_complete_led : out STD_LOGIC;
...
end zynq_ddr_wrapper;

architecture STRUCTURE of zynq_ddr_wrapper is
  component zynq_ddr is
  port (
    calib_complete_led : out STD_LOGIC;
    reset : in STD_LOGIC;
    ddr4_sdram_act_n : out STD_LOGIC;
  ...
  end component zynq_ddr;
begin
zynq_ddr_i: component zynq_ddr
     port map (
      calib_complete_led => calib_complete_led,
